...
const CheckIcon = () => (
  <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    <Path d="M20 6L9 17L4 12" stroke="#4BB329" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

const CloseIcon = () => (
  <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    <Path d="M18 6L6 18M6 6L18 18" stroke="#FF0000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

const MapIcon = () => (
  <Svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <Path d="M9 20L3 17V4L9 7L15 4L21 7V17L15 20L9 20Z" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M9 4V20M15 4V20" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);
    ...
    <View style={styles.card}>
      ...
      {item.pets && item.pets.length > 0 && (
        <View style={styles.petIconsContainer}>
          {item.pets.map((pet, index) => (
            <Text key={index} style={styles.petIcon}>
              {pet}
            </Text>
          ))}
        </View>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity style={styles.callNowButton}>
          <PhoneIcon />
          <Text style={styles.callNowText}>{language === "ar" ? "اتصل الآن" : "Call Now"}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.directionsButton}>
          <MapIcon />
          <Text style={styles.directionsText}>{language === "ar" ? "الاتجاهات" : "Directions"}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <Text style={[styles.emptyText, { textAlign: isRTL ? "right" : "left" }]}>
                {cityId ? (language === "ar" ? "لا توجد نتائج في هذه المدينة" : "No results in this city") : language === "ar" ? "لا توجد نتائج" : "No results"}
              </Text>
            </View>
          }
        />

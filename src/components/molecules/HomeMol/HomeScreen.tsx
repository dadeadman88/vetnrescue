...
const ContactIcon = ({ color = "#5FBE3A", width = 60, height = 40 }: { color?: string; width?: number; height?: number }) => (
...
const FlagItem = ({
  ...
  <TouchableOpacity style={styles.flagItem} activeOpacity={0.8} onPress={onPress}>
    ...
    <Typography 
      ...
      align="center"
      color={isSelected ? "#4BB329" : theme.color.black}
    >
      {item.code || item.name}
    </Typography>
  </TouchableOpacity>
          ...
          <View style={styles.headerWrapper}>
            <View style={styles.headerRow}>
              <TouchableOpacity onPress={() => navigate(SCREENS.EDIT_PROFILE)}>
                <ContactIcon color="#5FBE3A" width={50} height={30} />
                <Image
                  source={require("../../../assets/images/promoIcon.png")}
                  style={{ position: "absolute", left: 15, top: -15, width: 25, height: 25, tintColor: "#5FBE3A" }}
                  resizeMode="contain"
                />
              </TouchableOpacity>
